...
{
    public partial class FormConsultaHorasExtras : Form
    {
        ...
        public FormConsultaHorasExtras()
        {
            InitializeComponent();
        }
        ...
        private void FormConsultaHorasExtras_Load(object sender, EventArgs e)
        {
            Llenargrid();
        }
        ...
        public void Llenargrid()
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("SP_DGVHoraExtra", conexion);
